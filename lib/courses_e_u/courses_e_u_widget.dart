...
class CoursesEUWidget extends StatefulWidget {
  const CoursesEUWidget({Key key}) : super(key: key);

  @override
  _CoursesEUWidgetState createState() => _CoursesEUWidgetState();
}

class _CoursesEUWidgetState extends State<CoursesEUWidget> {
