...
class StagesEUWidget extends StatefulWidget {
  const StagesEUWidget({Key key}) : super(key: key);

  @override
  _StagesEUWidgetState createState() => _StagesEUWidgetState();
}

class _StagesEUWidgetState extends State<StagesEUWidget> {
